...
class Ui_RecorridoFecha(object):
    def setupUi(self, Form):
        ...
        self.TitleRFecha.setStyleSheet(("background-image: url()"))
        ...
        self.lFechaI.setGeometry(QtCore.QRect(170, 85, 131, 17))
        font = QtGui.QFont()
        ...
        self.lFechaF.setGeometry(QtCore.QRect(180, 130, 121, 17))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.dFechaInicial.setDisplayFormat("dd/MM/yyyy")
        self.dFechaInicial.setGeometry(QtCore.QRect(310, 85, 181, 27))
        self.dFechaInicial.setObjectName(_fromUtf8("dFechaInicial"))
        self.dFechaFinal = QtGui.QDateEdit(Form)
        self.dFechaFinal.setDisplayFormat("dd/MM/yyyy")
        self.dFechaFinal.setGeometry(QtCore.QRect(310, 130, 181, 27))
        ...
        self.tableViewRF.setStyleSheet(("background-image: url()")) 
        self.tableViewRF.setGeometry(QtCore.QRect(30, 170, 570, 270))

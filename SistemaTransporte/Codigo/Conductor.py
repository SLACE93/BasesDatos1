...
class Ui_Conductor(object):
    def setupUi(self, Conductor):
        ...
        self.lEstSalida.setStyleSheet("background-image: url()")
        ...
        self.lNLicencia.setStyleSheet("background-image: url()")
        ...
        self.lNombre.setStyleSheet("background-image: url()")
        ...
        self.titleConductores.setStyleSheet("background-image: url()")
